const zh = {
  ...
  settingsNav: {
    ...
    providers: "翻译源", translation: "翻译设置", selection: "划词翻译", glassWindow: "悬浮窗口", document: "文档翻译",
  ...
  shortcuts: {
    ...
    screenshot: "截图翻译", toggleWindow: "显示/隐藏窗口", glassWindow: "悬浮窗口", selectionTranslate: "划词翻译开关",
  ...
  toolbar: { glass: "悬浮窗口", screenshot: "截图翻译", selection: "划词翻译", selectionOn: "划词已开启", selectionOff: "划词已关闭", privacy: "隐私模式", theme: "主题" },
  ...
  settings: {
    ...
    shortcuts: { title: "快捷键设置", desc: "自定义全局快捷键", showWindow: "显示/隐藏主窗口", screenshot: "截图翻译", glassWindow: "悬浮窗口", selectionToggle: "开启/关闭划词翻译", recording: "按下快捷键...", conflict: "快捷键冲突", reset: "重置默认" },
    privacy: {
