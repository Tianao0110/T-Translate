const zh = {
  ...
  floatingWindow: {
    ...
    listenLangAuto: "自动",
    listenTarget: "翻译目标语（只翻定稿句，同语种自动跳过）",
    listenNoTranslate: "不翻译",
    listenExport: "导出字幕（SRT，含译文）",
    listenSourceAll: "全部声音",
    listenSourceOnly: "只听这个程序",
    listenSourceExcept: "除了这个程序",
    listenSourceExceptShort: "除",
    listenSourceHint: "声音来源：只听某个程序，或听全部但排除它。只列出已经发过声音的程序",
    listenSourceUnsupported: "指定程序需要 Windows 11；本机只能监听全部声音",
