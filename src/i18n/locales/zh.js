const zh = {
  ...
  settingsNav: {
    ...
    aiActions: "AI 动作",
    llm: "内置模型", ocr: "OCR 识别", tts: "朗读设置", listen: "听译模型", audio: "音频", interface: "界面外观", privacy: "隐私模式", about: "关于",
  ...
  about: {
    ...
    gpu: {
      ...
      switchLabel: "用显卡加速",
      testing: "正在逐个引擎自检",
      confirm: "开启后这些引擎会在显卡上运行（NVIDIA / AMD / Intel 通用）：本地 OCR、神经语音朗读、内置模型。听译识别留在 CPU。每个引擎会先自检，不行的自动留在 CPU；不需要重启。",
      enabled: "显卡加速已开启",
      disabled: "显卡加速已关闭",
      failed: "所有引擎都没能进显卡，保持 CPU：{{reason}}",
      engineNames: { ocr: "本地 OCR", tts: "神经语音朗读", asr: "听译识别", llm: "内置模型" },
  ...
  llm: {
    description: "程序自带的本地大模型：模型文件放进文件夹就能用，不用装 LM Studio，不开端口，不要密钥",
    engineName: "内置模型",
    engineNameWith: "内置模型（{{name}}）",
    packLabel: "{{name}}（{{role}}）",
    installed: "已安装",
    notInstalled: "未安装",
    mismatch: "文件不符",
