const en = {
  ...
  about: {
    ...
    gpu: {
      ...
      confirm: "These engines will run on the GPU (WebGPU, works on NVIDIA / AMD / Intel): local OCR, neural read-aloud. Listen recognition stays on the CPU. Each engine self-tests first and stays on the CPU if it cannot; no restart needed.",
      enabled: "GPU acceleration on",
      disabled: "GPU acceleration off",
      failed: "No engine could use the GPU, staying on the CPU: {{reason}}",
      engineNames: { ocr: "Local OCR", tts: "Neural read-aloud", asr: "Listen recognition" },
