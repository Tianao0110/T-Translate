const en = {
  ...
  providerSettings: {
    ...
    names: {
      'tengine': 'Built-in model',
      'local-llm': 'LM Studio (API)',
      'openai': 'OpenAI',
      'deepl': 'DeepL',
    ...
    descriptions: {
      'tengine': "Loads the model from the app's local folder",
  ...
  privacy: {
    ...
    modules: {
      ...
      updates: { name: "Update check", standard: "Available", secure: "Available", offline: "No network", offlineShort: "no network" }
    },
  ...
  about: {
    ...
    storage: {
      ...
      dataDir: "Data",
      modelsDir: "Models",
      inProgramDir: "Program folder",
      inUserDir: "User folder (install folder not writable)",
      legacyLabel: "Old folder",
      legacyFound: "{{count}} model packs ({{size}}) still there",
      openFolder: "Open folder",
      moveButton: "Move to program folder",
      moving: "Moving",
      moved: "Moved to the program folder",
      moveFailed: "Move failed: {{error}}. The old folder is untouched",
      cleanButton: "Clear old folder",
      cleanConfirm: "Delete {{path}} and everything in it? Settings, history and cache have already been copied to the new folder.",
      cleaning: "Clearing",
      cleaned: "Old folder cleared",
      cleanFailed: "Clear failed: {{error}}",
    },
    tengine: {
      title: "Engine status",
      running: "Running",
      idle: "Not started",
      ready: "Ready",
      healthOk: "Self-test passed",
      healthFail: "Self-test failed: {{reason}}",
      speed: "{{n}} tok/s",
      crashes: "{{n}} recent crashes",
      backoff: "Too many crashes, restarts paused",
    },
    gpu: {
      ...
      state: {
        gpu: "GPU (WebGPU)",
        gpuVulkan: "GPU (Vulkan)",
        cpu: "CPU",
        pending: "GPU from the next use",
        fallback: "Back on the CPU: {{reason}}",
        cpuOnly: "CPU ({{reason}})",
      },
    },
  ...
  llm: {
    ...
    packLabel: "{{name}} ({{role}})",
    packLabelUnlisted: "{{name}} (unverified · {{role}})",
    unverified: "Unverified",
    roleUnlistedHint: "A model outside the whitelist: loading is not a promise that every feature works, judge for yourself; its requests go to a trial log. Treated as a general model unless the file name belongs to the Hunyuan MT family (hy-mt, hunyuan-mt), which is translation-only",
    installed: "Installed",
    notInstalled: "Not installed",
    mismatch: "File mismatch",
    mismatchHint: "Right name and size, but the content does not match the official hash — download the official file again",
    checking: "Verifying",
    fileLine: "File {{file}} · {{size}} · {{license}}",
    howTo: "Download from a link below and put the file into the model folder; only files that pass the hash check are loaded, and the download never touches our servers",
    ...
    modelLabel: "Model",
    roleGeneral: "General",
    roleMt: "Translation only",
    roleGeneralHint: "Translation plus AI actions (summarize, explain, rewrite)",
    roleMtHint: "Translation only; with it selected, AI actions use another LLM source",
    packChanged: "Switched to {{name}}",
    enabledHint: "Enable it under Providers and keep it near the top; translation and AI actions then use it. Without the model file it steps aside instantly",
    run: {
      title: "Runtime",
      backend: "Backend",
      gpu: "GPU ({{device}})",
      ...
      state: "State",
      loaded: "Loaded: {{file}}",
      idle: "Not loaded (loads on use, unloads after 5 idle minutes)",
      speed: "Speed",
      speedValue: "{{n}} tok/s",
      speedUnknown: "Not measured yet",
      slowHint: "Under 8 tok/s: turn on GPU acceleration under About",
      selfTest: "Self-test",
      testing: "Testing…",
      testOk: "Self-test passed: {{n}} tok/s",
      testFail: "Self-test failed: {{reason}}",
    ...
    dev: {
      ...
      probe: "Probe",
      probing: "Probing…",
      probeUsable: "Usable (unverified)",
      probeUnusable: "Unusable",
      probeStep: "{{name}} {{ms}} ms",
      report: "Trial report",
      reportLine: "loads {{loads}} · requests {{requests}} · failures {{failures}} · stalls {{stalls}} · empty {{empty}} · loops {{loops}} · think leaks {{leaks}} · avg {{tps}} tok/s",
      reportEmpty: "No trial records yet",
      logText: "Record prompts and outputs in the trial log",
      logTextHint: "Unlisted models only, never in secure mode; for judging output quality",
    },
  },
  ocr: {
    ...
    tengineVision: {
      name: "Built-in vision model (PaddleOCR-VL)",
      desc: "The app's own vision model, run on this machine; every line comes with its position, steadier on complex layouts, tables and handwriting. Download the two files from the links and drop them into the model folder",
      notInstalled: "Not installed",
      partial: "Incomplete",
      mismatch: "File mismatch",
      notReady: "Both model files must be in place and verified before this engine can be used",
      howTo: "Download the two files below, keep their names, drop them into the model folder, then re-detect",
      linkModel: "Model (official)",
      linkEncoder: "Image encoder (official)",
    ...
    packs: {
      ...
      manifestOffline: "Offline mode never uses the network. Only installed packs are listed.",
  ...
  listen: {
    ...
    packs: {
      ...
      manifestOffline: "Offline mode never uses the network. Only installed models are listed.",
  ...
  providerError: {
    ...
    tengineNoModel: "Built-in model file not installed — add it under Settings → Local model",
