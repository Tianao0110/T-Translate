const en = {
  ...
  about: {
    ...
    gpu: {
      ...
      confirm: "These engines will run on the GPU: local OCR. Listen and read-aloud stay on the CPU. The first recognition takes about a second longer; no restart needed.",
      enabled: "GPU acceleration on",
      disabled: "GPU acceleration off",
      failed: "GPU unavailable, staying on the CPU: {{reason}}",
      fallback: "The GPU failed at runtime, back on the CPU: {{reason}}",
    },
