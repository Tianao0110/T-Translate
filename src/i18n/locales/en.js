const en = {
  ...
  floatingWindow: {
    ...
    listenLangAuto: "Auto",
    listenTarget: "Target language (finals only; same-language lines skipped)",
    listenNoTranslate: "Off",
    listenExport: "Export subtitles (SRT, with translations)",
    listenSourceAll: "All sound",
    listenSourceOnly: "Only this program",
    listenSourceExcept: "Everything except",
    listenSourceExceptShort: "not",
    listenSourceHint: "Sound source: listen to one program, or to everything except it. Only programs that have already played something are listed",
    listenSourceUnsupported: "Picking a program needs Windows 11; this machine can only listen to all sound",
