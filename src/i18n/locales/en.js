const en = {
  ...
  settingsNav: {
    ...
    llm: "Built-in model", ocr: "OCR", tts: "Text to Speech", listen: "Listen models", audio: "Audio", interface: "Appearance", privacy: "Privacy", about: "About",
  ...
  about: {
    ...
    gpu: {
      ...
      confirm: "These engines will run on the GPU (works on NVIDIA / AMD / Intel): local OCR, neural read-aloud, the built-in model. Listen recognition stays on the CPU. Each engine self-tests first and stays on the CPU if it cannot; no restart needed.",
      enabled: "GPU acceleration on",
      disabled: "GPU acceleration off",
      failed: "No engine could use the GPU, staying on the CPU: {{reason}}",
      engineNames: { ocr: "Local OCR", tts: "Neural read-aloud", asr: "Listen recognition", llm: "Built-in model" },
  ...
  llm: {
    description: "The app's own local model: drop the model file into the folder and it works — no LM Studio, no port, no key",
    engineName: "Built-in model",
    engineNameWith: "Built-in model ({{name}})",
    packLabel: "{{name}} ({{role}})",
    installed: "Installed",
