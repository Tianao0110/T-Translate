const en = {
  ...
  floatingWindow: {
    ...
    modeListen: "Listen",
    listenStart: "Start listening to system audio",
    ...
    listenNoTranslate: "No translation",
    listenExport: "Export subtitles (SRT, with translations)",
    listenExported: "Subtitles exported",
    listenIdle: "Click start to transcribe and translate system audio live (audio never touches disk)",
