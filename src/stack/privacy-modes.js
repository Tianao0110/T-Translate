...
export const PRIVACY_MODES = {
  ...
  [PRIVACY_MODE_IDS.OFFLINE]: {
    ...
    allowedProviders: [PROVIDER_IDS.TENGINE, PROVIDER_IDS.LOCAL_LLM, PROVIDER_IDS.OLLAMA],
    allowedOcrEngines: [OCR_ENGINES.LLM_VISION, OCR_ENGINES.TENGINE_VISION, OCR_ENGINES.WINDOWS_OCR, OCR_ENGINES.RAPID_OCR],
  },
};
