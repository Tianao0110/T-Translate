...
- Do NOT translate content inside special markers like ⟦...⟧`,
  ...
  subtitle: {
    id: 'subtitle',
    name: '字幕',
    description: '视频字幕，简洁明了',
    icon: 'Film',
    systemPrompt: `You are a subtitle translator. Translate the following text into {targetLang}.

Requirements:
- Keep translations concise and easy to read quickly
