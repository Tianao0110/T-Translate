...
### 📸 截图 OCR 翻译
- 截取屏幕区域进行文字识别
- 支持多种 OCR 引擎 (RapidOCR、Windows OCR、LLM Vision)
- 识别后自动翻译
...
│   ├── providers/          # 翻译源 Provider (kebab-case)
│   ├── services/           # 服务层 (含 tts/ 子目录)
│   ├── stores/             # Zustand 状态管理
│   ├── config/             # 前端配置
│   ├── i18n/               # 语言包 (zh, en)
│   ├── utils/              # 工具函数
...
| [国际化指南](docs/I18N_GUIDE.md) | 多语言开发指南 |
...
<p align="center">
  <strong>版本</strong>: v0.2.0 &nbsp;|&nbsp; <strong>更新日期</strong>: 2026-02-09
</p>
