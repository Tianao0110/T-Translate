...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.4.10-green" alt="Version">
...
支持中 / 英 / 日 / 韩 / 粤，可指定或自动判定；装上草稿引擎后中英边说边出字。默认听全部声音，Windows 11 可只听某一个程序。字幕可导出 SRT。模型在「设置 → 音频 → 听」下载（基础 153MB，草稿引擎 168MB 可选，高精度定稿档 806MB 可选，带音乐或噪声时更准）。
